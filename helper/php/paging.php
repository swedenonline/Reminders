	...
	function calculate_numPages(){
     ...
     function getPreviousPage(){
		 ...
		 if ($this->currentPage > 1){
             return "<a class='".PAGINGCSS."' href='".$this->url.$this->urlAppendString.$this->extraQuerysting."sc=".$this->sortcolumn."&sd=".$this->sortdirection."&start=".
             ($qrstr).
             "' title='Previous page'><img src='images/move_back.gif' style='border:0px;' /></a>";
         }
     }
     ...
     function getNextPage(){
		 ...
		 if ($this->currentPage < $this->numPages){
             return "<a  class='".PAGINGCSS."' href='".$this->url.$this->urlAppendString.$this->extraQuerysting."sc=".$this->sortcolumn."&sd=".$this->sortdirection."&start=".
             ($starts+$this->limit).
             "' title='Next page'><img src='images/move_forward.gif' style='border:0px;' /></a>";
         }
     }
     ...
     function getFirstPage(){
         if ($this->currentPage > 1){//If not on first page already
             return "<a class='".PAGINGCSS."' href='".$this->url.$this->urlAppendString.$this->extraQuerysting."sc=".$this->sortcolumn."&sd=".$this->sortdirection."&start=0' 
     ...
     function getLastPage(){
         ...
         if ($this->currentPage < $this->numPages){//If not on last page already
             ...
             return "<a class='".PAGINGCSS."' href='".$this->url.$this->urlAppendString.$this->extraQuerysting."sc=".$this->sortcolumn."&sd=".$this->sortdirection."&start=".$start_val
     ...
     function getPaginationLinks(){
         ...
         for ($i=$pageStart;$i<=$pageEnd;$i++){
			 ...
			 if ($i == $this->currentPage){
                 $ar[$i] = "<span class='".PAGINGCSS."'> [".$i."] </span>";
             } else {
                 if($i==1)
				 {
					 //echo("hello");
					 $ar[$i] = "<a class='".PAGINGCSS."' href='".$this->url.$this->urlAppendString.
